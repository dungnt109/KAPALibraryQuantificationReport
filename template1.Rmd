...
colnames <- c("Well", "Sample", "Type", "Given Concentration", "Calculated Concentration", "Ct Value", "$\\Delta T$ of Replicates", "$\\Delta T$")
...
kable(quantification_result, col.names = colnames, booktabs = TRUE, escape = FALSE) 
...
df <- data.frame(Name = c("Alice", "$\\Delta$Bob"),
                 Score = c(90, 85))
